...
if(_8[_9]){
_8[_9].call(_7,_8.rule);
}else{
if(_1.error){
_1[_9].call(_7,_8.rule);
}
}
};
function _3(){
var _a=_1.items,_b=true,_c,_d,re;
for(_c in _a){
if(typeof _2[_c]!=="undefined"){
_d=_2[_c];
_c=_a[_c];
re=_4(_c.rule);
if((!_c.required&&!_d.value.length)||(_c.required&&re.test(_d.value))||(!_c.required&&_d.value.length&&re.test(_d.value))){
_6(_d,_c,"success");
}else{
_6(_d,_c,"error");
_b=false;
